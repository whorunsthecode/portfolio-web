 ...
 *
 * Triggered when the user clicks the small brass envelope badge on
 * the driver's dashboard (see DriverCab.tsx). Visual language matches
 * OnboardingOverlay.tsx so the two overlays feel like the same
 * stationery set.
 *
 * Contact channels come from src/config/contact.ts — shared with the
 * Terminus InfoPanel pole so both update together.
 */
